...
Soporte técnico para comprender la lógica detrás de cada componente del sistema.

Material de referencia para futuras modificaciones, mantenimiento o ampliaciones del proyecto.

El objetivo es ofrecer una documentación clara, ordenada y accesible que facilite la comprensión del sistema tanto a desarrolladores como a estudiantes y colaboradores.
